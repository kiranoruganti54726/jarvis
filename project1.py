...
class Account:
    ...
    def update_interest(self):
        ...
        if (datetime.datetime.now().year == self.last_updated[1]):
            ...
            if (datetime.datetime.now().month < self.last_updated[0]):
                dif = (datetime.datetime.now().year - self.last_updated[1] - 1) * 12 + 12 - (
                            self.last_updated[0] - datetime.datetime.now().month)
            else:
                dif = (datetime.datetime.now().year - self.last_updated[1]) * 12 + (
                            datetime.datetime.now().month - self.last_updated[0])
    ...
    def withdraw(self):
        ...
        print
        "Insufficient funds to withdraw given amount."
        return -1
    ...
    def close_account(self):
        ...
        self.balance = 0
        print
        "You have withdrawn an amount of " + str(balance) + " and closed your account."
        self.active = 0
...
class Fixed(Account):
    ...
    def deposit(self):
        print
        "This is a Fixed Account. You will not be able to deposit."
        return -1

    def withdraw(self):
        print
        "This is a Fixed account. Close the account if you want to withdraw."
        return -1
...
while 1:
    ...
    if choice == 1:
        ...
        print
        "Your balance is ", account.balance_enquiry()
